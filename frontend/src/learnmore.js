    ...
    <div className="intro-section">
      ...
      <p className="home-text">
       ...
       <p className="home-text">
        ...
        <p className="home-text"><strong>3. Group Disparity:</strong> Compute the average credit score of the specified group and compare it with the average credit score of all other users.
